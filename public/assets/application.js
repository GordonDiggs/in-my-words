...
(function() {
  ...
  app.helpers.SuperView = (function(_super) {

    __extends(SuperView, _super);

    function SuperView() {
      SuperView.__super__.constructor.apply(this, arguments);
    }

    SuperView.prototype.render = function() {
      this.$el.html(JST[this.template](typeof this.serialize === "function" ? this.serialize() : void 0));
      return this.trigger('rendered');
    };

    SuperView.prototype.serialize = function() {
      var _ref;
      return {
...
(function() {
  ...
  app.models.Configuration = (function(_super) {
    ...
    Configuration.prototype.relations = [
      {
...
(function() {
  ...
  app.models.DictionaryEntry = (function(_super) {

    __extends(DictionaryEntry, _super);

    function DictionaryEntry() {
      DictionaryEntry.__super__.constructor.apply(this, arguments);
    }
...
(function() {
  ...
  app.models.Dictionary = (function(_super) {
    ...
    Dictionary.prototype.relations = [
      {
...
(function() {
  ...
  app.collections.Configurations = (function(_super) {

    __extends(Configurations, _super);

    function Configurations() {
      Configurations.__super__.constructor.apply(this, arguments);
    }

    Configurations.prototype.model = app.models.Configuration;

    Configurations.prototype.localStorage = new Backbone.LocalStorage("Configurations");
...
(function() {
  ...
  app.collections.DictionaryEntries = (function(_super) {

    __extends(DictionaryEntries, _super);
...
(function() {
  ...
  app.views.Configuration = (function(_super) {
    ...
    Configuration.prototype.template = "templates/configuration";

    Configuration.prototype.events = {
      "click .js-save": "save",
      "click .js-reset": "reset"
    };

    Configuration.prototype.initialize = function() {
      return this.bind('rendered', this.renderDictionary);
    };
    ...
    Configuration.prototype.save = function(e) {
      e.preventDefault();
...
(function() {
  ...
  app.views.DictionaryEntry = (function(_super) {
    ...
    DictionaryEntry.prototype.template = "templates/dictionary-entry";

    DictionaryEntry.prototype.events = {
...
(function() {
  ...
  app.views.Dictionary = (function(_super) {
    ...
    Dictionary.prototype.renderItems = function() {
      var _this = this;
      return this.model.get('entries').each(function(item) {
        return _this.renderItem(item);
      });
    };

    Dictionary.prototype.renderItem = function(item) {
      var entryView;
...
(function() {
  ...
  app.configuration.FetchesConfig = (function() {

    function FetchesConfig() {}

    FetchesConfig.prototype.fetch = function() {
      var config, configs;
...
(function() {
  ...
  app.initializers.ListensForMessages = (function() {

    function ListensForMessages() {}

    ListensForMessages.prototype.listen = function() {
        ...
        if ($('body').hasClass('js-background-page')) {
          return chrome.extension.onRequest.addListener(function(request, sender, sendResponse) {
            ...
            response = (function() {
              switch (request.type) {
                case "config":
                  return new app.configuration.FetchesConfig().fetch().toJSON();
              }
            })();
...
(function() {
  ...
  app.initializers.RendersConfiguration = (function() {

    function RendersConfiguration() {}

    RendersConfiguration.prototype.render = function() {
      return $(window.document).ready(function() {
        var config, view;
        if ($('body').hasClass('js-options-page')) {
          config = new app.configuration.FetchesConfig().fetch();
          view = new app.views.Configuration({
            model: config
          });
          return $('.root').append(view.render().el);
        }
      });
    };

    return RendersConfiguration;
...
(function() {
  ...
  app.initializers.TransformsContent = (function() {

    function TransformsContent() {}

    TransformsContent.prototype.transform = function() {
...
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/configuration"] = function(__obj) {
    if (!__obj) __obj = {};
...
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/dictionary-entry"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
...
(function() {
  this.JST || (this.JST = {});
  this.JST["templates/dictionary"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
